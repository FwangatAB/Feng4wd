...
#overlord.trackingFidelityLim = 60

#Frames to wait before moving.
#Defaults to 160
#overlord.waitedFrames = 20
...
def compass(headingDegrees):
    ...
    if compassInitFlag == False:
       ...
       print "this is initial heading degree %s" % initialRawHeading
       exit 
...
#				startFlag = False
        ...
        cv2.putText(frame,"Bot inital deg: "+str(initialRawHeading)+" Deg",(guiX+20,guiY+60),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(0,0,0))

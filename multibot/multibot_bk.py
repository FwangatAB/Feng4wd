...
def draw_str():
	cv2.putText(frame,"MultiBot:"+str(cscX)+" , "+str(cscY),(guiX+20,guiY+20),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(0,0,0))
	cv2.putText(frame,"Target:"+str(tX)+" , "+str(tY),(guiX+20,guiY+40),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(0,0,0))
	cv2.putText(frame,"Compass initReading: "+str(initCompass)+" Deg",(guiX+20,guiY+60),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(0,0,0))
    cv2.putText(frame,"Target deg: "+strTargetDegs+" Deg",(guiX+20,guiY+100),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(0,0,0))
    cv2.putText(frame,"Bot turningdeg: "+str(shortestAngle)+" Deg",(guiX+20,guiY+80),cv2.FONT_HERSHEY_COMPLEX_SMALL,.7,(0,0,0))
